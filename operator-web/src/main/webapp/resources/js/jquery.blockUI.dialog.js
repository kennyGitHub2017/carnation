    ...
    var defaultOptions = {
        ...
        confirmElement: function (settings) {
            ...
            var html = [
                ...
                message,
                '</div>',
                '<div class="btns"><input type="button" value="',
                okText,
                '" class="btn ok-btn"/>',
                '<input type="button" value="',
                cancelText,
                '" class="btn cancel-btn"/></div>'
            ].join("");
