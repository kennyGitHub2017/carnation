...
$(function(){
    form1 = $('form[name=form1]'),
        ...
        area = $('input[name=operatorAreaId]' , form1),
        vale = ['选择省份','选择城市','选择地区'];
