...
<body mid="m-news">
	...
	<div class="mod-banner"
		style="background-image: url(${staticPath}/static/platform/assets/images/banner-news.jpg)"></div>

	<div class="mod-block">
		<div class="cont-width clearfix" style="width:1000px">
			...
			<div class="content-main col-xs-12">${ refereeArticle.content }
			...
			<div class="content-nav col-xs-12">
				...
				<c:if test="${listArticlePrevious!=null}">
					...
					<p>
						<a href="/news/${listArticlePrevious.id}">上一篇： ${ listArticlePrevious.title }</a>
					</p>
				...
				<c:if test="${listArticleNext!=null}">
					...
					<p class="">
						<a href="/news/${listArticleNext.id}">下一篇： ${ listArticleNext.title }</a>
					</p>
				</c:if>
