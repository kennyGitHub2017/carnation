...
<script src="${staticPath}/static/platform/assets/js/jquery-1.8.2.min.js"></script>
<script src="${staticPath}/static/platform/assets/js/wow.min.js"></script>
<script src="${staticPath}/static/platform/assets/nav/responsive-nav.js"></script>
