...
//	private IIntegralLogService integralLogService;
	...
	public void sina_login_api(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		String url = this.sina_login_url + "?client_id=" + config.getSinaLoginId() + "&redirect_uri="
	...
	public String sina_login_bind(HttpServletRequest request, HttpServletResponse response, String code)
		...
		String auth_url = "https://api.weibo.com/oauth2/authorize?client_id="
				+ this.configService.getSysConfig().getSinaLoginId() + "&response_type=code&redirect_uri="
				+ redirect_uri;
		String token_url = "https://api.weibo.com/oauth2/access_token?client_id="
				+ this.configService.getSysConfig().getSinaLoginId() + "&client_secret="
				+ this.configService.getSysConfig().getSinaLoginKey()
		...
		if (status == HttpStatus.SC_OK) {
			...
			if (status == HttpStatus.SC_OK) {
				...
				String user_info_url = "https://api.weibo.com/2/users/show.json?access_token=" + access_token
						+ "&uid=" + sina_openid;
...
//					+ "/buyer/account_bind.htm?error=true";
	...
	public String sina_login_bind_finish(HttpServletRequest request, HttpServletResponse response,
...
//		}
	...
	public static void main(String[] args) throws Exception {
		...
		config.setSinaLoginId("3863193702");
		config.setSinaLoginKey("16b62bbfc99c0d9028c199566429c798");
		String redirect_uri = CommUtil.encode("http://www.thinker.vc/sina_login_bind.htm");
		String auth_url = "https://api.weibo.com/oauth2/authorize?client_id=" + config.getSinaLoginId()
				+ "&response_type=code&redirect_uri=" + redirect_uri;
		System.out.println(auth_url);
		String token_url = "https://api.weibo.com/oauth2/access_token?client_id=" + config.getSinaLoginId()
				+ "&client_secret=" + config.getSinaLoginKey()
