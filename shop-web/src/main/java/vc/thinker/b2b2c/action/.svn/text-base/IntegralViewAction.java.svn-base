...
public class IntegralViewAction {
	...
	public ModelAndView integral(HttpServletRequest request, HttpServletResponse response, String begin,
		...
		/*
				ModelAndView mv = new JModelAndView("integral.html", configService.getSysConfig(), 1, request, response);*/
		/*H5*/
		ModelAndView mv = new JModelAndView("jfShop.html", configService.getSysConfig(), 1, request, response);
	...
	public synchronized ModelAndView integral_view(HttpServletRequest request, HttpServletResponse response, String id) {
		...
		if (configService.getSysConfig().getIntegralStore()) {
			...
			synchronized(this){
				...
				if (obj != null) {
					...
					else if (exchange_status == -6) {  // add by yuleijia on 2017.4.13
						mv.addObject("op_title", "商品库存为零，兑换失败");
					}
				}
	...
	public synchronized ModelAndView integral_exchange2(HttpServletRequest request, HttpServletResponse response,
	...
	public synchronized ModelAndView integral_exchange3(HttpServletRequest request, HttpServletResponse response,
	...
	@SecurityMapping(title = "地址修改", value = "/integral/cart_address.htm*", rtype = "buyer", rname = "积分兑换", rcode = "integral_exchange", rgroup = "积分兑换")
	@RequestMapping("/integral/cart_address.htm")
	@ResponseBody
	public ModelAndView cart_address(HttpServletRequest request, HttpServletResponse response, String id) {
		ModelAndView mv = new JModelAndView("integral_cart_address.html", configService.getSysConfig(), 1,
				request, response);
	...
	@SecurityMapping(title = "地址保存", value = "/integral/cart_address_save.htm*", rtype = "buyer", rname = "积分兑换", rcode = "integral_exchange", rgroup = "积分兑换")
	@RequestMapping("/integral/cart_address_save.htm")
	public ModelAndView cart_address_save(HttpServletRequest request, HttpServletResponse response,
		...
		mv = new JModelAndView("integral_cart_address_result.html", configService.getSysConfig(), 1, request,
				response);
