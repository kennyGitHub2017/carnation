var tipsbox=function(title,fn){
	...
	if(document.getElementById("tipsboxStyle")){
	    ...
	    str+="#tips{position: fixed;left: 50%;top: 50%;transform: translate3d(-50%,-50%,0);background: #f2f2f2;border-radius: 0.24rem;width: 5.4rem;height: 2.08rem;font-size: 16px;z-index: 100000;}";
