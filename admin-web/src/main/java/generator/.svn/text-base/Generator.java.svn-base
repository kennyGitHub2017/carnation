...
import vc.thinker.b2b2c.core.annotation.Title;
...
public class Generator {
	...
	public void generate() {
		...
		try {
			...
			String html_targetPath = System.getProperty("user.dir") + this.resultDir;
			String java_targetPath = System.getProperty("user.dir") + this.resultDir + "\\"
