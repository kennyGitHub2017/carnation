...
//	private QueryTools queryTools;
	...
	@SecurityMapping(title = "自营满就减活动列表", value = "/admin/enoughreduce_self_list.htm*", rtype = "admin", rname = "满就减管理", rcode = "enoughreduce_self_admin", rgroup = "商城管理")
	@RequestMapping("/admin/enoughreduce_self_list.htm")
	public ModelAndView enoughreduce_list(HttpServletRequest request, HttpServletResponse response,
			String currentPage, String orderBy, String orderType, String ertitle, String erstatus,
			String erbegin_time, String erend_time) {
		ModelAndView mv = new JModelAndView("admin/blue/enoughreduce_self_list.html",
...
//				+ "/admin/enoughreduce_self_list.htm", "", params, pList, mv);
	 ...
	 */
	@SecurityMapping(title = "自营满就减活动添加", value = "/admin/enoughreduce_self_add.htm*", rtype = "admin", rname = "满就减管理", rcode = "enoughreduce_self_admin", rgroup = "商城管理")
	@RequestMapping("/admin/enoughreduce_self_add.htm")
	public ModelAndView enoughreduce_add(HttpServletRequest request, HttpServletResponse response,
			String currentPage) {
		ModelAndView mv = new JModelAndView("admin/blue/enoughreduce_self_add.html",
				configService.getSysConfig(), 0, request, response);
	 ...
	 * @throws ParseException
	 */
	@SecurityMapping(title = "自营满就减活动修改", value = "/admin/enoughreduce_self_edit.htm*", rtype = "admin", rname = "满就减管理", rcode = "enoughreduce_self_admin", rgroup = "商城管理")
	@RequestMapping("/admin/enoughreduce_self_edit.htm")
	public ModelAndView enoughreduce_edit(HttpServletRequest request, HttpServletResponse response,
...
//		}
	 ...
	 */
	@SuppressWarnings("unused")
	@SecurityMapping(title = "自营满就减活动保存", value = "/admin/enoughreduce_self_save.htm*", rtype = "admin", rname = "满就减管理", rcode = "enoughreduce_self_admin", rgroup = "商城管理")
	@RequestMapping("/admin/enoughreduce_self_save.htm")
	public ModelAndView enoughreduce_save(HttpServletRequest request, HttpServletResponse response,
			String id, String currentPage, String cmd, String list_url, String add_url, String count) {
		WebForm wf = new WebForm();
...
//			this.enoughreduceService.update(enoughreduce);
	...
	@SuppressWarnings("unused")
	@SecurityMapping(title = "自营满就减活动删除", value = "/admin/enoughreduce_self_del.htm*", rtype = "admin", rname = "满就减管理", rcode = "enoughreduce_self_admin", rgroup = "商城管理")
...
//		}
	 ...
	 * @return
	 */
	@SecurityMapping(title = "自营满就减活动商品列表", value = "/admin/enoughreduce_self_goods_list.htm*", rtype = "admin", rname = "满就减管理", rcode = "enoughreduce_self_admin", rgroup = "商城管理")
	@RequestMapping("/admin/enoughreduce_self_goods_list.htm")
	public ModelAndView enoughreduce_self_goods_list(HttpServletRequest request,
			HttpServletResponse response, String er_id, String currentPage, String orderBy, String orderType,
			String class_id, String brand_id, String goods_name) {
		ModelAndView mv = new JModelAndView("admin/blue/enoughreduce_self_goods.html",
				configService.getSysConfig(), 0, request, response);
...
//		mv.addObject("er", er);
	...
	@SuppressWarnings("unused")
	@SecurityMapping(title = "满就减商品AJAX更新", value = "/admin/enoughreduce_goods_ajax.htm*", rtype = "admin", rname = "满就减管理", rcode = "enoughreduce_self_admin", rgroup = "商城管理")
	@RequestMapping("/admin/enoughreduce_goods_ajax.htm")
	public void enoughreduce_goods_ajax(HttpServletRequest request, HttpServletResponse response, String id,
			String er_id) throws ClassNotFoundException {
...
//		}
	...
	@SecurityMapping(title = "自营满就减活动商品批量管理", value = "/admin/enoughreduce_goods_admin.htm*", rtype = "admin", rname = "满就减管理", rcode = "enoughreduce_self_admin", rgroup = "商城管理")
	@RequestMapping("/admin/enoughreduce_goods_admin.htm")
	public String enoughreduce_goods_admin(HttpServletRequest request, HttpServletResponse response,
			String mulitId, String currentPage, String er_id, String type) {
...
//		this.enoughreduceService.update(enoughreduce);
	...
	@SecurityMapping(title = "自营满就减活动ajax", value = "/admin/enoughreduce_self_ajax.htm*", rtype = "admin", rname = "满就减管理", rcode = "enoughreduce_self_admin", rgroup = "商城管理")
	@RequestMapping("/admin/enoughreduce_self_ajax.htm")
	public void enoughreduce_ajax(HttpServletRequest request, HttpServletResponse response, String id,
