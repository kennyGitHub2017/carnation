...
//	private StatTools statTools;
	...
	@SecurityMapping(title = "商品统计", value = "/admin/self_stat_goods.htm*", rtype = "admin", rname = "商品统计", rcode = "self_stat_goods", rgroup = "商城管理")
...
//		mv.addObject("gbs", gbs);
	...
	@SecurityMapping(title = "有信息的商品", value = "/admin/self_stat_goods_list.htm*", rtype = "admin", rname = "商品统计", rcode = "self_stat_goods", rgroup = "商城管理")
...
//					CommUtil.showPageAjaxHtml(url, "", cp, pages));
	...
	@SecurityMapping(title = "商品统计结果", value = "/admin/self_stat_goods_done.htm*", rtype = "admin", rname = "商品统计", rcode = "self_stat_goods", rgroup = "商城管理")
...
//							allsale += gl.getGoods_salenum();
							price = price == 0 ? CommUtil.null2Double(gl.getPrice()) : (price + CommUtil
...
//							}
	...
	@SuppressWarnings({"rawtypes", "unchecked", "unused"})
	@SecurityMapping(title = "全商城统计结果", value = "/admin/self_stat_all.htm*", rtype = "admin", rname = "商品统计", rcode = "self_stat_goods", rgroup = "商城管理")
