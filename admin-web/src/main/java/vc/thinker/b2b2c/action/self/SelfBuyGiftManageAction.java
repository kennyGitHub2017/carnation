...
public class SelfBuyGiftManageAction {
	...
	@SecurityMapping(title = "自营满就送列表", value = "/admin/buygift_self_list.htm*", rtype = "admin", rname = "满就送管理", rcode = "buygift_self_manage", rgroup = "商城管理")
	@RequestMapping("/admin/buygift_self_list.htm")
	public ModelAndView buygift_self_list(HttpServletRequest request, HttpServletResponse response,
			String currentPage, String orderBy, String orderType, String gift_status, String beginTime,
			String endTime, String store_name) {
		ModelAndView mv = new JModelAndView("admin/blue/buygift_self_list.html",
...
//				"", params, pList, mv);
	...
	@SecurityMapping(title = "自营满就送添加", value = "/admin/buygift_self_add.htm*", rtype = "admin", rname = "满就送管理", rcode = "buygift_self_manage", rgroup = "商城管理")
	@RequestMapping("/admin/buygift_self_add.htm")
	public ModelAndView buygift_add(HttpServletRequest request, HttpServletResponse response,
			String currentPage) {
	...
	@SecurityMapping(title = "自营满就送商品", value = "/admin/buy_goods_self.htm*", rtype = "admin", rname = "满就送管理", rcode = "buygift_self_manage", rgroup = "商城管理")
...
//		mv.addObject("gcs", gcs);
	...
	@SecurityMapping(title = "自营满就送load", value = "/admin/buy_goods_self_load.htm*", rtype = "admin", rname = "满就送管理", rcode = "buygift_self_manage", rgroup = "商城管理")
	@RequestMapping("/admin/buy_goods_self_load.htm")
	public void buy_goods_self_load(HttpServletRequest request, HttpServletResponse response,
			String goods_name, String gc_id, String goods_ids) {
		boolean ret = true;
...
//		}
	...
	@SecurityMapping(title = "自营满就送保存", value = "/admin/buygift_self_save.htm*", rtype = "admin", rname = "满就送管理", rcode = "buygift_self_manage", rgroup = "商城管理")
	@RequestMapping("/admin/buygift_self_save.htm")
	public ModelAndView buygift_self_save(HttpServletRequest request, HttpServletResponse response,
			String id, String currentPage, String goods_ids, String gift_ids) {
		WebForm wf = new WebForm();
		String[] ids = goods_ids.split(",");
...
//		mv.addObject("op_title", "保存满就送成功");
	...
	@SecurityMapping(title = "自营满就送商品", value = "/admin/buy_gift_self.htm*", rtype = "admin", rname = "满就送管理", rcode = "buygift_self_manage", rgroup = "商城管理")
	...
	public ModelAndView buy_gift_self(HttpServletRequest request, HttpServletResponse response) {
		ModelAndView mv = new JModelAndView("admin/blue/buy_gift_self.html", configService.getSysConfig(), 0,
				request, response);
//		List<GoodsClass> gcs = this.goodsClassService
//				.query("select obj from GoodsClass obj where obj.parent.id is null order by obj.sequence asc",
//						null, -1, -1);
//		mv.addObject("gcs", gcs);
	...
	@SecurityMapping(title = "自营满就送详情", value = "/admin/buygift_self_info.htm*", rtype = "admin", rname = "满就送管理", rcode = "buygift_self_manage", rgroup = "商城管理")
	@RequestMapping("/admin/buygift_self_info.htm")
	public ModelAndView buygift_self_info(HttpServletRequest request, HttpServletResponse response,
...
//		}
	...
	@SecurityMapping(title = "自营满就送停止", value = "/admin/buygift_stop.htm*", rtype = "admin", rname = "满就送管理", rcode = "buygift_self_manage", rgroup = "商城管理")
...
//		}
	...
	public void gift_count_adjust(HttpServletRequest request, HttpServletResponse response, String gid,
			String count) {
