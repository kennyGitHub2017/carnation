...
//	}
	...
	public void verify_storename(HttpServletRequest request, HttpServletResponse response, String storeName,
			Long id) {
		boolean ret = true;
		List<StoreBO> stores = this.storeService.findStoreIsExist(storeName, id);
//		Map params = new HashMap();
