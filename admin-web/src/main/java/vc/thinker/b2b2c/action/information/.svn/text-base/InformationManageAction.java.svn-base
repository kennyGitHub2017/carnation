...
import com.sinco.carnation.cms.service.CmsIndexTemplateServiceImpl;
...
//	private ImageTools imageTools;
	@Autowired
	private CmsIndexTemplateServiceImpl cmsIndexTemplateService;
//	@Autowired
...
//	private CircleViewTools circleViewTools;
	 ...
	 * @return
	 */
	@SecurityMapping(title = "资讯首页头部编辑列表", value = "/admin/information_head_list.htm*", rtype = "admin", rname = "资讯管理", rcode = "information_admin", rgroup = "内容管理")
	@RequestMapping("/admin/information_head_list.htm")
	public ModelAndView information_head_list(HttpServletRequest request, HttpServletResponse response,
			String type, String currentPage, String title, String author, String classid) {
		ModelAndView mv = new JModelAndView("admin/blue/information_head_list.html",
...
//		mv.addObject("cmsTools", cmsTools);
	...
	@SecurityMapping(title = "资讯首页头部编辑保存", value = "/admin/information_head_save.htm*", rtype = "admin", rname = "资讯管理", rcode = "information_admin", rgroup = "内容管理")
	@RequestMapping("/admin/information_head_save.htm")
	public ModelAndView information_head_save(HttpServletRequest request, HttpServletResponse response,
...
//			}
			...
			mv.addObject("add_url", CommUtil.getURL(request)
					+ "/admin/information_head_list.htm?currentPage=" + currentPage);
		} else {
	 ...
	 * @return
	 */
	@SecurityMapping(title = "资讯列表", value = "/admin/information_list.htm*", rtype = "admin", rname = "资讯管理", rcode = "information_admin", rgroup = "内容管理")
	...
	public ModelAndView information_list(HttpServletRequest request, HttpServletResponse response,
			String currentPage, InformationVO vo, MyPage<InformationBO> page) {

		ModelAndView mv = new JModelAndView("admin/blue/information_list.html", configService.getSysConfig(),
				0, request, response);
		page.setPageSize(10);
		page = informationService.queryList(vo, page);
		CommUtil.saveIPageList2ModelAndView("", "", null, page, mv);
		List<InformationClassBO> infoclassList = informationClassService.findAll();
		mv.addObject("infoclassList", infoclassList);
		mv.addObject("vo", vo);
		mv.addObject("cmsTools", cmsTools);
		return mv;
	}

	@SecurityMapping(title = "资讯待审核列表", value = "/admin/information_verifylist.htm*", rtype = "admin", rname = "资讯管理", rcode = "information_admin", rgroup = "内容管理")
	@RequestMapping("/admin/information_verifylist.htm")
	public ModelAndView information_verifylist(HttpServletRequest request, HttpServletResponse response,
			String currentPage, InformationVO vo, MyPage<InformationBO> page) {
		ModelAndView mv = new JModelAndView("admin/blue/information_verifylist.html",
				configService.getSysConfig(), 0, request, response);
		page.setPageSize(10);
		vo.setVerifyStatus(new ArrayList<Integer>());
		if (InformationContant.IS_VERIFY.equals(vo.getIsVerify())) {
			vo.getVerifyStatus().add(InformationContant.STATUS_20);
			vo.getVerifyStatus().add(InformationContant.STATUS_FU10);
		} else {
			vo.getVerifyStatus().add(InformationContant.STATUS_10);
		}
		page = informationService.queryList(vo, page);
		CommUtil.saveIPageList2ModelAndView("", "", null, page, mv);
		List<InformationClassBO> infoclassList = informationClassService.findAll();
	 ...
	 */
	@SecurityMapping(title = "资讯添加", value = "/admin/information_add.htm*", rtype = "admin", rname = "资讯管理", rcode = "information_admin", rgroup = "内容管理")
...
//		mv.addObject("imageTools", imageTools);
		List<InformationClassBO> informationClassList = informationClassService.findAll();
		mv.addObject("informationClassList", informationClassList);
		mv.addObject("cmsTools", cmsTools);
	 ...
	 * @throws ParseException
	 */
	@SecurityMapping(title = "资讯编辑", value = "/admin/information_edit.htm*", rtype = "admin", rname = "资讯管理", rcode = "information_admin", rgroup = "内容管理")
	...
	public ModelAndView information_edit(HttpServletRequest request, HttpServletResponse response, Long id,
		...
		if (id != null && !id.equals("")) {
			InformationBO information = this.informationService.findById(id);
			List<InformationClassBO> informationClassList = informationClassService.findAll();
			mv.addObject("informationClassList", informationClassList);
//			mv.addObject("infoclass", infoclass);
...
//			mv.addObject("imageTools", imageTools);
	 ...
	 * @return
	 */
	@SecurityMapping(title = "资讯保存", value = "/admin/information_save.htm*", rtype = "admin", rname = "资讯管理", rcode = "information_admin", rgroup = "内容管理")
	...
	public ModelAndView information_save(HttpServletRequest request, HttpServletResponse response,
			String currentPage, InformationVO vo, String listUrl, String addUrl) {
		User user = SecurityUserHolder.getCurrentUser();
		if (null == vo.getId() || vo.getId().equals("")) {
			informationService.addInformation(vo, user.getId());
		} else {
			informationService.updateInformation(vo, user.getId());
		}
		...
		if (addUrl != null) {
			mv.addObject("add_url", addUrl + "?currentPage=" + currentPage);
		}
		return mv;
	}

	@SecurityMapping(title = "资讯审核", value = "/admin/information_verify.htm*", rtype = "admin", rname = "资讯管理", rcode = "information_admin", rgroup = "内容管理")
	@RequestMapping("/admin/information_verify.htm")
	public ModelAndView information_verify(HttpServletRequest request, HttpServletResponse response,
			String id, String currentPage) {
		ModelAndView mv = new JModelAndView("admin/blue/information_verify.html",
				configService.getSysConfig(), 0, request, response);
		if (id != null && !id.equals("")) {
...
//			mv.addObject("imageTools", imageTools);
	...
	@SecurityMapping(title = "资讯审核保存", value = "/admin/information_verify_save.htm*", rtype = "admin", rname = "资讯管理", rcode = "information_admin", rgroup = "内容管理")
	@RequestMapping("/admin/information_verify_save.htm")
	public ModelAndView verify_save(HttpServletRequest request, HttpServletResponse response,
			String currentPage, InformationVO vo, String listUrl) {
		ModelAndView mv = new JModelAndView("admin/blue/success.html", configService.getSysConfig(), 0,
				request, response);
		if (vo.getId() != null) {
			this.informationService.verifyInformation(vo);
		}
		mv.addObject("list_url", listUrl);
		mv.addObject("op_title", "资讯审核成功");
		return mv;
	}

	@SecurityMapping(title = "资讯删除", value = "/admin/information_del.htm*", rtype = "admin", rname = "资讯管理", rcode = "information_admin", rgroup = "内容管理")
	...
	public String information_del(HttpServletRequest request, HttpServletResponse response, String mulitId,
		...
		User user = SecurityUserHolder.getCurrentUser();
		informationService.batchDelete(ids, user.getId());
		return "redirect:information_list.htm?currentPage=" + currentPage;
	}

	@SuppressWarnings("unused")
	@SecurityMapping(title = "资讯置顶", value = "/admin/stick.htm*", rtype = "admin", rname = "资讯管理", rcode = "information_admin", rgroup = "内容管理")
	@RequestMapping("/admin/stick.htm")
	public String stick(HttpServletRequest request, HttpServletResponse response, String id,
			String currentPage) {
		ModelAndView mv = new JModelAndView("admin/blue/information_add.html", configService.getSysConfig(),
				0, request, response);
		if (id != null && !id.equals("")) {
	...
	@SecurityMapping(title = "资讯ajax", value = "/admin/information_ajax.htm*", rtype = "admin", rname = "资讯管理", rcode = "information_admin", rgroup = "内容管理")
	...
	@SuppressWarnings("unused")
	@SecurityMapping(title = "资讯商品", value = "/admin/information_goods.htm*", rtype = "admin", rname = "资讯管理", rcode = "information_admin", rgroup = "内容管理")
	@RequestMapping("/admin/information_goods.htm")
	public ModelAndView information_goods(HttpServletRequest request, HttpServletResponse response,
			String currentPage, String gc_id, String goods_name) {
		ModelAndView mv = new JModelAndView("admin/blue/information_goods.html",
				configService.getSysConfig(), 0, request, response);
...
//	}
	...
	@SuppressWarnings("unused")
	@SecurityMapping(title = "资讯预览", value = "/admin/info_preview.htm*", rtype = "admin", rname = "资讯管理", rcode = "information_admin", rgroup = "内容管理")
	...
	public ModelAndView info_preview(HttpServletRequest request, HttpServletResponse response, String id) {
		ModelAndView mv = new JModelAndView("/cms/detail.html", configService.getSysConfig(), 1, request,
				response);
...
//		}
	...
	@SuppressWarnings("unused")
	@SecurityMapping(title = "资讯首页管理", value = "/admin/cms_template_list.htm*", rtype = "admin", rname = "资讯管理", rcode = "information_admin", rgroup = "内容管理")
	@RequestMapping("/admin/cms_template_list.htm")
	public ModelAndView cms_template_list(HttpServletRequest request, HttpServletResponse response,
			String currentPage, String title, String author, String classid) {
		ModelAndView mv = new JModelAndView("admin/blue/cms_template_list.html",
				configService.getSysConfig(), 0, request, response);
...
//		}
	 ...
	 * @throws ParseException
	 */
	@SecurityMapping(title = "楼层编辑", value = "/admin/cms_template_edit.htm*", rtype = "admin", rname = "资讯楼层", rcode = "information_floor", rgroup = "内容管理")
	@RequestMapping("/admin/cms_template_edit.htm")
	public ModelAndView cms_template_edit(HttpServletRequest request, HttpServletResponse response,
			String id, String currentPage) {
...
//		}
	...
	@SuppressWarnings("unused")
	@SecurityMapping(title = "楼层保存", value = "/admin/cms_template_save.htm*", rtype = "admin", rname = "资讯楼层", rcode = "information_floor", rgroup = "内容管理")
	@RequestMapping("/admin/cms_template_save.htm")
	public ModelAndView cms_template_save(HttpServletRequest request, HttpServletResponse response,
			String id, String currentPage, String cmd, String list_url, String add_url) {
		WebForm wf = new WebForm();
...
//			this.cmsIndexTemplateService.update(cmsindextemplate);
	 ...
	 * @return
	 */
	@SecurityMapping(title = "资讯首页楼层添加", value = "/admin/cms_template_add.htm*", rtype = "admin", rname = "资讯楼层", rcode = "information_floor", rgroup = "内容管理")
	...
	@SecurityMapping(title = "资讯首页楼层添加", value = "/admin/cms_template_draw.htm*", rtype = "admin", rname = "资讯楼层", rcode = "information_floor", rgroup = "内容管理")
	...
	public ModelAndView cms_template_draw(HttpServletRequest request, HttpServletResponse response, String id) {
		ModelAndView mv = new JModelAndView("admin/blue/cms_template_draw.html",
				configService.getSysConfig(), 0, request, response);
//		if (id != null && !id.equals("")) {
//			CmsIndexTemplate cmsindextemplate = this.cmsIndexTemplateService
//					.getObjById(Long.parseLong(id));
...
//		}
	...
	@SecurityMapping(title = "资讯首页楼层删除", value = "/admin/cms_template_del.htm*", rtype = "admin", rname = "资讯楼层", rcode = "information_floor", rgroup = "内容管理")
...
//						.getObjById(Long.parseLong(id));
	...
	@SecurityMapping(title = "楼层模板商品分类编辑", value = "/admin/cms_template_class.htm*", rtype = "admin", rname = "资讯楼层", rcode = "information_floor", rgroup = "内容管理")
	@RequestMapping("/admin/cms_template_class.htm")
	public ModelAndView cms_template_class(HttpServletRequest request, HttpServletResponse response,
			String currentPage, String id) {
		ModelAndView mv = new JModelAndView("admin/blue/cms_template_class.html",
				configService.getSysConfig(), 0, request, response);
//		CmsIndexTemplate cmsindextemplate = this.cmsIndexTemplateService
//				.getObjById(Long.parseLong(id));
//		List<GoodsClass> gcs = this.goodsClassService
...
//		mv.addObject("gf_tools", this.gf_tools);
	...
	@SecurityMapping(title = "楼层模板商品分类编辑", value = "/admin/cms_template_class_load.htm*", rtype = "admin", rname = "资讯楼层", rcode = "information_floor", rgroup = "内容管理")
	@RequestMapping("/admin/cms_template_class_load.htm")
	public ModelAndView cms_template_class_load(HttpServletRequest request, HttpServletResponse response,
			String currentPage, String gc_id) {
		ModelAndView mv = new JModelAndView("admin/blue/cms_template_class_load.html",
				configService.getSysConfig(), 0, request, response);
...
//		mv.addObject("gc", gc);
	...
	@SuppressWarnings({"rawtypes", "unchecked"})
	@SecurityMapping(title = "楼层模板商品分类编辑", value = "/admin/cms_template_class_save.htm*", rtype = "admin", rname = "资讯楼层", rcode = "information_floor", rgroup = "内容管理")
	@RequestMapping("/admin/cms_template_class_save.htm")
	public String cms_template_class_save(HttpServletRequest request, HttpServletResponse response,
...
//		this.cmsIndexTemplateService.update(obj);
	...
	@SecurityMapping(title = "楼层模板商品", value = "/admin/cms_template_goods.htm*", rtype = "admin", rname = "资讯楼层", rcode = "information_floor", rgroup = "内容管理")
	@RequestMapping("/admin/cms_template_goods.htm")
	public ModelAndView cms_template_goods(HttpServletRequest request, HttpServletResponse response,
			String currentPage, String id, String count) {
		ModelAndView mv = new JModelAndView("admin/blue/cms_template_goods.html",
				configService.getSysConfig(), 0, request, response);
//		CmsIndexTemplate cmsindextemplate = this.cmsIndexTemplateService
//				.getObjById(Long.parseLong(id));
//		List<GoodsClass> gcs = this.goodsClassService
...
//		mv.addObject("gf_tools", this.gf_tools);
	...
	@SecurityMapping(title = "楼层模板商品", value = "/admin/cms_template_goods_load.htm*", rtype = "admin", rname = "资讯楼层", rcode = "information_floor", rgroup = "内容管理")
	@RequestMapping("/admin/cms_template_goods_load.htm")
	public ModelAndView cms_template_goods_load(HttpServletRequest request, HttpServletResponse response,
			String currentPage, String gc_id, String goods_name, String page, String module_id) {
		ModelAndView mv = new JModelAndView("admin/blue/cms_template_goods_load.html",
				configService.getSysConfig(), 0, request, response);
...
//				+ "&goods_name=" + goods_name, pList, mv);
	...
	public String cms_template_goods_save(HttpServletRequest request, HttpServletResponse response,
...
//		this.cmsIndexTemplateService.update(obj);
	...
	@SecurityMapping(title = "楼层模板资讯", value = "/admin/cms_template_info.htm*", rtype = "admin", rname = "资讯楼层", rcode = "information_floor", rgroup = "内容管理")
	@RequestMapping("/admin/cms_template_info.htm")
	public ModelAndView cms_template_info(HttpServletRequest request, HttpServletResponse response,
			String currentPage, String id, String count, String type) {
		ModelAndView mv = new JModelAndView("admin/blue/cms_template_info.html",
				configService.getSysConfig(), 0, request, response);
//		CmsIndexTemplate cmsindextemplate = this.cmsIndexTemplateService
//				.getObjById(Long.parseLong(id));
...
//		mv.addObject("imageTools", imageTools);
	...
	@SecurityMapping(title = "楼层模板资讯", value = "/admin/cms_template_info_load.htm*", rtype = "admin", rname = "资讯楼层", rcode = "information_floor", rgroup = "内容管理")
	@RequestMapping("/admin/cms_template_info_load.htm")
	public ModelAndView cms_template_info_load(HttpServletRequest request, HttpServletResponse response,
			String currentPage, String ic_id, String info_name, String page, String module_id) {
		ModelAndView mv = new JModelAndView("admin/blue/cms_template_info_load.html",
				configService.getSysConfig(), 0, request, response);
		if (!CommUtil.null2String(page).equals("")) {
			mv = new JModelAndView("admin/blue/" + page + ".html", configService.getSysConfig(), 0, request,
					response);
...
//		mv.addObject("imageTools", imageTools);
	...
	@SuppressWarnings({"rawtypes", "unchecked"})
	@SecurityMapping(title = "楼层模板资讯", value = "/admin/cms_template_info_save.htm*", rtype = "admin", rname = "资讯楼层", rcode = "information_floor", rgroup = "内容管理")
	@RequestMapping("/admin/cms_template_info_save.htm")
	public String cms_template_info_save(HttpServletRequest request, HttpServletResponse response,
			String list_title, String id, String ids, String type) {
//		CmsIndexTemplate obj = this.cmsIndexTemplateService.getObjById(Long
//				.parseLong(id));
		String[] id_list = ids.split(",");
		Map map = new HashMap();
...
//		this.cmsIndexTemplateService.update(obj);
	...
	@SecurityMapping(title = "楼层模板品牌", value = "/admin/cms_template_brand.htm*", rtype = "admin", rname = "资讯楼层", rcode = "information_floor", rgroup = "内容管理")
	...
	public ModelAndView goods_floor_brand(HttpServletRequest request, HttpServletResponse response, String id) {
		ModelAndView mv = new JModelAndView("admin/blue/cms_template_brand.html",
				configService.getSysConfig(), 0, request, response);
//		CmsIndexTemplate obj = this.cmsIndexTemplateService.getObjById(Long
//				.parseLong(id));
...
//		mv.addObject("gf_tools", this.gf_tools);
	...
	@SuppressWarnings({"rawtypes", "unchecked"})
	@SecurityMapping(title = "楼层模板品牌保存", value = "/admin/cms_template_brand_save.htm*", rtype = "admin", rname = "资讯楼层", rcode = "information_floor", rgroup = "内容管理")
...
//		this.cmsIndexTemplateService.update(obj);
	...
	@SecurityMapping(title = "楼层模板品牌加载", value = "/admin/cms_template_brand_load.htm*", rtype = "admin", rname = "资讯楼层", rcode = "information_floor", rgroup = "内容管理")
	@RequestMapping("/admin/cms_template_brand_load.htm")
	public ModelAndView cms_template_brand_load(HttpServletRequest request, HttpServletResponse response,
			String currentPage, String name) {
		ModelAndView mv = new JModelAndView("admin/blue/cms_template_brand_load.html",
				configService.getSysConfig(), 0, request, response);
...
//				"&name=" + CommUtil.null2String(name), pList, mv);
	...
	@SecurityMapping(title = "楼层模板0元试用", value = "/admin/cms_template_free.htm*", rtype = "admin", rname = "资讯楼层", rcode = "information_floor", rgroup = "内容管理")
	@RequestMapping("/admin/cms_template_free.htm")
	public ModelAndView cms_template_free(HttpServletRequest request, HttpServletResponse response,
			String id, String currentPage, String count) {
		ModelAndView mv = new JModelAndView("admin/blue/cms_template_free.html",
				configService.getSysConfig(), 0, request, response);
//		CmsIndexTemplate cmsindextemplate = this.cmsIndexTemplateService
//				.getObjById(Long.parseLong(id));
...
//		mv.addObject("gf_tools", this.gf_tools);
	...
	@SuppressWarnings({"rawtypes", "unchecked"})
	@SecurityMapping(title = "楼层模板0元试用", value = "/admin/cms_template_free_save.htm*", rtype = "admin", rname = "资讯楼层", rcode = "information_floor", rgroup = "内容管理")
	@RequestMapping("/admin/cms_template_free_save.htm")
	public String cms_template_free_save(HttpServletRequest request, HttpServletResponse response, String id,
			String ids) {
//		CmsIndexTemplate obj = this.cmsIndexTemplateService.getObjById(Long
//				.parseLong(id));
		String[] id_list = ids.split(",");
...
//		this.cmsIndexTemplateService.update(obj);
	...
	@SecurityMapping(title = "楼层模板0元试用", value = "/admin/cms_template_free_load.htm*", rtype = "admin", rname = "资讯楼层", rcode = "information_floor", rgroup = "内容管理")
	@RequestMapping("/admin/cms_template_free_load.htm")
	public ModelAndView cms_template_free_load(HttpServletRequest request, HttpServletResponse response,
			String currentPage, String name, String page, String fc_id, String free_name, String module_id) {
		ModelAndView mv = new JModelAndView("admin/blue/cms_template_free_load.html",
				configService.getSysConfig(), 0, request, response);
		if (!CommUtil.null2String(page).equals("")) {
			mv = new JModelAndView("admin/blue/" + page + ".html", configService.getSysConfig(), 0, request,
					response);
...
//				+ "&free_name=" + free_name, pList, mv);
	...
	@SecurityMapping(title = "楼层模板圈子", value = "/admin/cms_template_circle.htm*", rtype = "admin", rname = "资讯楼层", rcode = "information_floor", rgroup = "内容管理")
	@RequestMapping("/admin/cms_template_circle.htm")
	public ModelAndView cms_template_circle(HttpServletRequest request, HttpServletResponse response,
			String id, String currentPage, String count) {
		ModelAndView mv = new JModelAndView("admin/blue/cms_template_circle.html",
				configService.getSysConfig(), 0, request, response);
//		CmsIndexTemplate cmsindextemplate = this.cmsIndexTemplateService
//				.getObjById(Long.parseLong(id));
...
//		mv.addObject("circleViewTools", circleViewTools);
	...
	@SuppressWarnings({"rawtypes", "unchecked"})
	@SecurityMapping(title = "楼层模板圈子", value = "/admin/cms_template_circle_save.htm*", rtype = "admin", rname = "资讯楼层", rcode = "information_floor", rgroup = "内容管理")
	@RequestMapping("/admin/cms_template_circle_save.htm")
	public String cms_template_circle_save(HttpServletRequest request, HttpServletResponse response,
			String id, String ids) {
//		CmsIndexTemplate obj = this.cmsIndexTemplateService.getObjById(Long
//				.parseLong(id));
		String[] id_list = ids.split(",");
...
//		this.cmsIndexTemplateService.update(obj);
	...
	@SecurityMapping(title = "楼层模板圈子", value = "/admin/cms_template_circle_load.htm*", rtype = "admin", rname = "资讯楼层", rcode = "information_floor", rgroup = "内容管理")
	...
	public ModelAndView cms_template_circle_load(HttpServletRequest request, HttpServletResponse response,
		...
		ModelAndView mv = new JModelAndView("admin/blue/cms_template_circle_load.html",
				configService.getSysConfig(), 0, request, response);
		if (!CommUtil.null2String(page).equals("")) {
			mv = new JModelAndView("admin/blue/" + page + ".html", configService.getSysConfig(), 0, request,
					response);
...
//	}
	 ...
	 * @return
	 */
	@SecurityMapping(title = "资讯推荐", value = "/admin/information_advert_view.htm*", rtype = "admin", rname = "资讯推荐", rcode = "advert_admin", rgroup = "内容管理")
	@RequestMapping("/admin/information_advert_view.htm")
	public ModelAndView invitation_advert_view(HttpServletRequest request, HttpServletResponse response,
		...
		if (id != null && !id.equals("")) {
			...
			InformationBO information = this.informationService.findById(CommUtil.null2Long(id));
			mv.addObject("adTypeJg", AdvertContant.ADVERT_TPYE_JG_PROJECT);
			mv.addObject("informationId", id);
			mv.addObject("information", information);
			mv.addObject("aps", apsList);
			mv.addObject("informationFlag", true);
		}
		return mv;
	}
}