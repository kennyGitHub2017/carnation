package vc.thinker.b2b2c.action.stat;
...
//	private StatTools statTools;
	...
	@SecurityMapping(title = "用户统计", value = "/admin/stat_user.htm*", rtype = "admin", rname = "用户统计", rcode = "stat_user", rgroup = "用户管理")
	@RequestMapping("/admin/stat_user.htm")
	public ModelAndView stat_user(HttpServletRequest request, HttpServletResponse response) {
		ModelAndView mv = new JModelAndView("admin/blue/stat_user.html", configService.getSysConfig(), 0,
				request, response);
	...
	@SecurityMapping(title = "用户统计结果", value = "/admin/stat_user_done.htm*", rtype = "admin", rname = "用户统计", rcode = "stat_user", rgroup = "用户管理")
	@RequestMapping("/admin/stat_user_done.htm")
	public ModelAndView stat_user_done(HttpServletRequest request, HttpServletResponse response,
...
//						user_day_order_counts, JsonFormat.compact()));
	...
	@SecurityMapping(title = "订单统计", value = "/admin/stat_order.htm*", rtype = "admin", rname = "订单统计", rcode = "stat_order", rgroup = "商城管理")
	...
	public ModelAndView stat_order(HttpServletRequest request, HttpServletResponse response) {
		ModelAndView mv = new JModelAndView("admin/blue/stat_order.html", configService.getSysConfig(), 0,
				request, response);
	...
	@SuppressWarnings("rawtypes")
	@SecurityMapping(title = "订单统计", value = "/admin/stat_order_done.htm*", rtype = "admin", rname = "订单统计", rcode = "stat_order", rgroup = "商城管理")
	@RequestMapping("/admin/stat_order_done.htm")
	public ModelAndView stat_order_done(HttpServletRequest request, HttpServletResponse response,
			String beginTime, String endTime) {
		ModelAndView mv = new JModelAndView("admin/blue/stat_order_result.html",
...
//				mv.addObject("oss", oss);
	...
	@SecurityMapping(title = "访问统计", value = "/admin/stat_visit.htm*", rtype = "admin", rname = "订单统计", rcode = "stat_order", rgroup = "商城管理")
	...
	public ModelAndView stat_visit(HttpServletRequest request, HttpServletResponse response) {
		ModelAndView mv = new JModelAndView("admin/blue/stat_visit.html", configService.getSysConfig(), 0,
				request, response);

		return mv;
	}

	@SecurityMapping(title = "商品统计", value = "/admin/stat_goods.htm*", rtype = "admin", rname = "商品统计(定时)", rcode = "stat_goods", rgroup = "商城管理")
	...
	public ModelAndView stat_goods(HttpServletRequest request, HttpServletResponse response) {
		ModelAndView mv = new JModelAndView("admin/blue/stat_goods.html", configService.getSysConfig(), 0,
				request, response);
...
//		mv.addObject("gbs", gbs);
	...
	@SecurityMapping(title = "有信息的商品", value = "/admin/stat_goods_list.htm*", rtype = "admin", rname = "商品统计(定时)", rcode = "stat_goods", rgroup = "商城管理")
	@RequestMapping("/admin/stat_goods_list.htm")
	public ModelAndView stat_goods_list(HttpServletRequest request, HttpServletResponse response,
			String beginTime, String endTime, String currentPage, String goods_name, String class_id,
			String brand_id) {
		ModelAndView mv = null;
		if (endTime != null && beginTime != null && !endTime.equals("") && !beginTime.equals("")) {
			mv = new JModelAndView("admin/blue/stat_goods_list.html", configService.getSysConfig(), 0,
					request, response);
			...
			if (class_id != null && !class_id.equals("")) {
				Set<Long> ids = this.genericIds(this.goodsClassService.getObjById(CommUtil
						.null2Long(class_id)));
				para.put("ids", ids);
...
//					CommUtil.showPageAjaxHtml(url, "", cp, pages));
	...
	@SecurityMapping(title = "商品统计结果", value = "/admin/stat_goods_done.htm*", rtype = "admin", rname = "商品统计(定时)", rcode = "stat_goods", rgroup = "商城管理")
	@RequestMapping("/admin/stat_goods_done.htm")
	public ModelAndView stat_goods_done(HttpServletRequest request, HttpServletResponse response,
			String beginTime, String endTime, String ids, String statType) {
		ModelAndView mv = null;
		if (ids != null && !ids.equals("")) {
			...
			if (arr.length == 1) {// 一件商品的统计
				mv = new JModelAndView("admin/blue/stat_single_goods_result.html",
						configService.getSysConfig(), 0, request, response);
				if (begin != null && end != null) {
					Calendar cal = Calendar.getInstance();
					cal.setTime(begin);
...
//							}
					...
					while (it.hasNext()) {
						...
						clicksb.append("['").append(string).append("',").append(goods_clickfrom.get(string))
								.append("],");
					}
					...
					while (it.hasNext()) {
						String string = (String) it.next();
						ordersb.append("['").append(string).append("',").append(goods_ordertype.get(string))
								.append("],");
					}
					...
					while (it.hasNext()) {
						...
						if (string.equals("")) {
							specsb.append("['").append("默认规格").append("',")
									.append(goods_spectype.get(string)).append("],");
						} else {
...
//					mv.addObject("imageTools", imageTools);
				...
				mv = new JModelAndView("admin/blue/stat_multi_goods_result.html",
						configService.getSysConfig(), 0, request, response);
				if (begin != null && end != null) {
					Calendar cal = Calendar.getInstance();
					cal.setTime(begin);
...
//						stat.put(calday, idgoodmap);
	...
	@SecurityMapping(title = "全商城统计结果", value = "/admin/stat_all.htm*", rtype = "admin", rname = "商品统计(定时)", rcode = "stat_goods", rgroup = "商城管理")
	@RequestMapping("/admin/stat_all.htm")
	public ModelAndView stat_all(HttpServletRequest request, HttpServletResponse response, String beginTime,
			String endTime, String goods_name, String class_id, String brand_id, String statType) {
		ModelAndView mv = null;
		Date begin = CommUtil.formatDate(beginTime);
		Date end = CommUtil.formatDate(endTime);
		Map map = CommUtil.cal_time_space(begin, end);
		...
		mv = new JModelAndView("admin/blue/stat_all_goods_result.html", configService.getSysConfig(), 0,
				request, response);
		if (begin != null && end != null) {
...
//				stat.add(todaymap);
	...
	@SecurityMapping(title = "地域统计", value = "/admin/stat_area.htm*", rtype = "admin", rname = "地域统计", rcode = "stat_area", rgroup = "商城管理")
	@RequestMapping("/admin/stat_area.htm")
	public ModelAndView stat_area(HttpServletRequest request, HttpServletResponse response) {
		ModelAndView mv = new JModelAndView("admin/blue/stat_area.html", configService.getSysConfig(), 0,
				request, response);
		return mv;
	}

	@SuppressWarnings({"rawtypes", "unchecked"})
	@SecurityMapping(title = "地域统计结果", value = "/admin/stat_area_done.htm*", rtype = "admin", rname = "地域统计", rcode = "stat_area", rgroup = "商城管理")
	@RequestMapping("/admin/stat_area_done.htm")
	public ModelAndView stat_area_done(HttpServletRequest request, HttpServletResponse response,
			String beginTime, String endTime) {
