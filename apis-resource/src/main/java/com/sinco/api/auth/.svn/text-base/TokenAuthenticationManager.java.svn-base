...
import com.sinco.api.auth.model.VerifyTokenResponse;
import com.sinco.api.exception.AuthTokenException;
import com.sinco.api.util.JerseyClientFactory;
import com.sinco.api.util.ObjectMapperProvider;
...
public class TokenAuthenticationManager implements AuthenticationManager {
	...
	public TokenAuthenticationManager(String authorizationServerUrl, String key, String secret) {
		...
		authorizationValue = "Basic ".concat(new String(Base64.encodeBase64(key.concat(":").concat(secret)
				.getBytes())));
	}
