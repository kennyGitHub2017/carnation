...
public abstract class WebUtils {
	...
	public static String doGet(String url, Map<String, String> params, int connectTimeout, int readTimeout)
			throws IOException {
		return doGet(url, params, null, connectTimeout, readTimeout, DEFAULT_CHARSET);
	}
	 ...
	 * @throws IOException
	 */
	public static void doGet(String url, Map<String, String> params, String charset,
		...
		try {
			...
			String outCharset = getResponseCharset(conn.getContentType());
			...
			if (es == null) {
				...
				String msg = getStreamAsString(es, outCharset);
