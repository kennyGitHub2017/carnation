(function($){
  ...
  var addCar={
    ...
    totalAmount:function(){
      ...
      $(".addcar-jies .jies-heji").text("合计：¥ "+ total_amount.toFixed(1));
   ...
   $(document).ready(function(){
      ...
      $(".wrapper").on("change",".shop_title .fl.c_checkbox",function(){
         if($(this).prop("checked")){
             $(this).parent().next(".cart_item").find(".fl.c_checkbox").prop("checked",true);

         }else{
           $(this).parent().next(".cart_item").find(".fl.c_checkbox").removeAttr("checked");
         }
