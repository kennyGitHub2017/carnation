...
public class TestEmail {
	public static boolean sendEmail(String username, String password, String smtp_server,
			String from_mail_address, String email, String subject, String content) {
		boolean ret = true;
	...
	public static void main(String[] args) {
		...
		boolean ret = sendEmail(username, password, smtp_server, from_mail_address, email, subject, content);
		if (ret) {
