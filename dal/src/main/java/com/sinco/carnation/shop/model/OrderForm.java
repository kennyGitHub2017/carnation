...
public class OrderForm extends BaseModel {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4185612529173232662L;
	...
	public String getCnUseralias() {
		return cnUseralias;
	}

	public void setCnUseralias(String cnUseralias) {
		this.cnUseralias = cnUseralias;
	}
