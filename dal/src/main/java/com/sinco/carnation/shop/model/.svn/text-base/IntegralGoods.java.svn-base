...
public class IntegralGoods extends BaseModel {
	/**
	 * serialVersionUID
	 */
	private static final long serialVersionUID = 3436567135265884892L;
	...
	public void setIgUserLevel(Integer igUserLevel) {
		this.igUserLevel = igUserLevel;
	}
