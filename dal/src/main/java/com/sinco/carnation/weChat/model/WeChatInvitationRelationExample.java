package com.sinco.carnation.weChat.model;
...
public class WeChatInvitationRelationExample extends AbstractExample<WeChatInvitationRelationBO> {
	...
	public WeChatInvitationRelationExample() {
