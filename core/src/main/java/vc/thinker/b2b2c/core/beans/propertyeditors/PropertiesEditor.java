...
public class PropertiesEditor extends PropertyEditorSupport {
	...
	/**
	 * Any of these characters, if they're first after whitespace or first on a line, mean that the line is a
	...
	/**
	 * Remove comment lines, even if they contain whitespace before the comment marker. This happens
	 * automatically on JDK >= 1.4, but we need to do this manually on JDK 1.3.
	 */
