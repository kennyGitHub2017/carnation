...
import vc.thinker.b2b2c.core.beans.ObjectUtils;

/**
 * Combined exception, composed of individual PropertyAccessException instances. An object of this class is
 * created at the beginning of the binding process, and errors added to it as necessary.
 * 
 * <p>
 * The binding process continues when it encounters application-level propertyAccessExceptions, applying those
 * changes that can be applied and storing rejected changes in an object of this class.
 * 
 * @author Rod Johnson
