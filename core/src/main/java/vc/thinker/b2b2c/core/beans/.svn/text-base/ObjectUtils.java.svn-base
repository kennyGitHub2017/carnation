...
/**
 * Miscellaneous object utility methods. Mainly for internal use within the framework; consider Jakarta's
 * Commons Lang for a more comprehensive suite of object utilities.
 * 
...
public abstract class ObjectUtils {
	...
	/**
	 * Return whether the given throwable is a checked exception: that is, neither a RuntimeException nor an
	 * Error.
	 * 
	 * @param ex
	 ...
	 * <p>
	 * Compares arrays with <code>Arrays.equals</code>, performing an equality check based on the array
	...
	/**
	 * Return as hash code for the given object; typically the value of <code>{@link Object#hashCode()}</code>
	 * . If the object is an array, this method will delegate to any of the <code>nullSafeHashCode</code>
	 * methods for arrays in this class. If the object is <code>null</code>, this method returns 0.
	 * 
	...
	/**
	 * Return a String representation of the contents of the specified array. The String representation
	 * consists of a list of the array's elements, enclosed in curly braces (<code>"{}"</code>). Adjacent
	 * elements are separated by the characters <code>", "</code> (a comma followed by a space). Returns
	 ...
	 * @return the object's identity as String representation, or <code>null</code> if the object was
	 *         <code>null</code>
	 */
	...
	/**
	 * Return a content-based String representation if <code>obj</code> is not <code>null</code>; otherwise
