...
public class CustomBooleanEditor extends PropertyEditorSupport {
	...
	/**
	 * Create a new CustomBooleanEditor instance, with "true"/"on"/"yes" and "false"/"off"/"no" as recognized
	 * String values.
	 * <p>
	 ...
	 * 
	 * @param trueString
	 *            the String value that represents true: for example, "true" (VALUE_TRUE), "on" (VALUE_ON),
	 *            "yes" (VALUE_YES) or some custom value
	 * @param falseString
	 *            the String value that represents false: for example, "false" (VALUE_FALSE), "off"
	 *            (VALUE_OFF), "no" (VALUE_NO) or some custom value
	 * @param allowEmpty
	 *            if empty strings should be allowed
	 * @see #VALUE_TRUE
	 * @see #VALUE_FALSE
