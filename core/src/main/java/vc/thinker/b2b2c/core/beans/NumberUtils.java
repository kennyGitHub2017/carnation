...
/**
 * Miscellaneous utility methods for number conversion and parsing. Mainly for internal use within the
 * framework; consider Jakarta's Commons Lang for a more comprehensive suite of string utilities.
 * 
...
public abstract class NumberUtils {
	 ...
	 *             if the target class is not supported (i.e. not a standard Number subclass as included in
	 *             the JDK)
	 * @see java.lang.Byte
	 * @see java.lang.Short
	 ...
	 * <code>decode</code> methods. Trims the input <code>String</code> before attempting to parse the number.
	 * Supports numbers in hex format (with leading 0x) and in octal format (with leading 0).
	 * 
	 * @param text
	 *            the text to convert
	 * @param targetClass
	...
	/**
	 * Decode a {@link java.math.BigInteger} from a {@link String} value. Supports decimal, hex and octal
	 * notation.
	 * 
