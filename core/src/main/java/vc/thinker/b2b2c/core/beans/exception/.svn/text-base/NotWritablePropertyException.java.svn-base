...
/**
 * Exception thrown on an attempt to set the value of a property that isn't writable, because there's no
 * setter method. In some situations alternatives are presented.
 * 
 * @author Rod Johnson
...
public class NotWritablePropertyException extends PropertyException {
	...
	public NotWritablePropertyException(Class beanClass, String propertyName) {
		super(beanClass, propertyName, "Bean property '" + propertyName
