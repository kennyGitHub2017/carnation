package vc.thinker.b2b2c.core.constant;
...
public class Globals {
	public final static String DEFAULT_SYSTEM_TITLE = "Thinkervc B2B2C商城系统";// 系统默认名称
	...
	public final static String DEFAULT_WBESITE_NAME = "Thinkervc";// 软件名称
	public final static String DEFAULT_CHECK_NAME = "aHR0cDovL2NoZWNrLnRoaW5rZXIudmMvY2hlY2s/bmFtZT1iMmIyYw==";// 软件名称
	...
	public final static String DEFAULT_TABLE_SUFFIX = "thinkervc_";// 默认表前缀名
	public final static String THIRD_ACCOUNT_LOGIN = "thinkervc_thid_login_";// 第三方账号登录的前缀
	...
	/** 线上环境静态文件地址 **/
	public static final String STATIC_SERVER_PATH_CN="http://filei-ysysgo.oss-cn-shenzhen.aliyuncs.com";
	public static final String STATIC_SERVER_PATH_COM="http://filei-ysysgo.oss-cn-shenzhen.aliyuncs.com";
