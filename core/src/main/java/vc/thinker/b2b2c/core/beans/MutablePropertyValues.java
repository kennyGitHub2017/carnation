...
public class MutablePropertyValues implements PropertyValues, Serializable {
	...
	/**
	 * Deep copy constructor. Guarantees PropertyValue references are independent, although it can't deep copy
	 * objects currently referenced by individual PropertyValue objects.
	 * 
	 * @param source
	...
	public PropertyValue[] getPropertyValues() {
		return (PropertyValue[]) this.propertyValueList.toArray(new PropertyValue[this.propertyValueList
				.size()]);
	}
