 ...
 * 
 * <p>
 * Mainly intended for usage within the framework, determining the target type of values to be added to a
 * collection or map (to be able to attempt type conversion if appropriate).
 * 
 * <p>
 * Only usable on Java 5. Use an appropriate JdkVersion check before calling this class, if a fallback for JDK
 * 1.3/1.4 is desirable.
 * 
