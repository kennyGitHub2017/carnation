...
/**
 * Assert utility class that assists in validating arguments. Useful for identifying programmer errors early
 * and obviously at runtime.
 * 
 * <p>
...
public abstract class Assert {
	...
	/**
	 * Assert that a string has valid text content; that is, it must not be <code>null</code> and must contain
