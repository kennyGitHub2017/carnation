...
/**
 * Superclass for exceptions related to a property access, such as type mismatch or invocation target
 * exception.
 * 
 * @author Rod Johnson
...
public abstract class PropertyAccessException extends PropertyException {
	...
	/**
	 * Return the PropertyChangeEvent that resulted in the problem. Only available if an actual bean property
	 * was affected.
	 */
