...
/**
 * Exception thrown when referring to an invalid bean property. Carries the offending bean class and property
 * name.
 * 
...
public class PropertyException extends BeansException {
	...
	public PropertyException(Class beanClass, String propertyName, String msg, Throwable ex) {
		super("Invalid property '" + propertyName + "' of bean class [" + beanClass.getName() + "]: " + msg,
				ex);
