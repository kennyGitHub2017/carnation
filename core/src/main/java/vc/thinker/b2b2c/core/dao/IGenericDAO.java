package vc.thinker.b2b2c.core.dao;
...
public interface IGenericDAO<T> {
	 ...
	 * @param params
	 *            查询语句中的参数，使用Map传递，结合查询语句中的参数命名来确定 Map map=new HashMap(); map.put("id",id);
	 *            map.put("role",role); 该方法的使用方法为: query(
	 ...
	 * 
	 * @param query
	 *            完整的查询语句，使用命名参数。比如：select user from User user where user.name = :name and user.properties =
	 *            :properties
	 * @param params
	 *            查询条件中的参数的值。使用Map
	 * @param begin
