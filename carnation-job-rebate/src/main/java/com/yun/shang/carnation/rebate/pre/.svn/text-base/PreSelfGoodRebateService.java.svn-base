package com.yun.shang.carnation.rebate.pre;
...
public class PreSelfGoodRebateService extends RebateServiceBasic {
	...
	@Override
	public synchronized boolean rebate(Long sellerId, Long orderId) {
	...
	public synchronized boolean buyGoodsRebate(Long sellerId, Long orderId) {
		...
		if (sellerId == null || orderId == null) {
			logger.error("[self good rebate]  faile, sellerId or orderId is empty, orderId=" + orderId
					+ ",sellerId=" + sellerId);
