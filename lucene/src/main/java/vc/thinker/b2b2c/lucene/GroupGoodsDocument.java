...
@Document(indexName = "groupgoods", type = "groupgoods", shards = 3, replicas = 1, refreshInterval = "-1")
public class GroupGoodsDocument extends EsDocument {
	@Id
	...
	public String toString() {
		...
		builder.append("GroupGoodsDocument [id=");
		builder.append(id);
