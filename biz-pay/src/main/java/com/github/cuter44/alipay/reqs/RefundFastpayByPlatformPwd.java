...
public class RefundFastpayByPlatformPwd extends WebRequestBase {
	// KEYS
	public static final List<String> KEYS_PARAM_NAME = Arrays.asList("_input_charset", "batch_no",
			"batch_num", "detail_data", "notify_url", "partner", "refund_date", "seller_email",
			"seller_user_id", "service");

	// CONSTRUCT
	public RefundFastpayByPlatformPwd(Properties prop) {
		super(prop);
		this.setProperty("service", "refund_fastpay_by_platform_pwd");
		this.setProperty("refund_date",
	...
	// SIGN
	@Override
	public RefundFastpayByPlatformPwd sign() throws UnsupportedEncodingException {
