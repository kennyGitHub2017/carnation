...
public class PaymentDetailList extends ArrayList<IPaymentItem> {
	 ...
	 *                on size%gt;1000, according to alipay spec.
	 */
	@Override
	...
	public String toString() {
		...
		for (IPaymentItem i : this) {
			...
			sb.append(i.getSn()).append('^').append(i.getAccount()).append('^').append(i.getName())
					.append('^').append(String.format("%.2f", i.getAmount())).append('^').append(i.getMemo());
		}
