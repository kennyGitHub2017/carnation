...
public class PaymentItem implements IPaymentItem, IRoyaltyItem, IPaymentResult {
	// FIELDS
	public String sn;
	 ...
	 */
	public PaymentItem(String sn, String account, String name, Double amount, boolean success, String memo,
			String tradeNo, Date date) {
		this.setSn(sn);
		this.setAccount(account);
		this.setName(name);
		this.setAmount(amount);
