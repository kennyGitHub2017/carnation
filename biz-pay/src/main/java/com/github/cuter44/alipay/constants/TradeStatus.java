...
public enum TradeStatus {
	...
	WAIT_SELLER_SEND_GOODS(2, "等待卖家发货"), COD_WAIT_SELLER_SEND_GOODS(3, "等待卖家发货(货到付款)"),

	WAIT_BUYER_CONFIRM_GOODS(4, "等待买家签收"), COD_WAIT_BUTER_PAY(5, "等待买家签收(货到付款)"),

	COD_WAIT_SYS_PAY_SELLER(6, "等待到帐"),

	TRADE_PENDING(7, "卖家帐号无法收款"),

	TRADE_SUCCESS(8, "交易成功"), TRADE_FINISH(10, "交易结束"),
