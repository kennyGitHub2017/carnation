...
/**
 * General response passed by req.execute() or alipay callback/redirect gateways Actually reqs/gateways passed
 * excatly response type, i.e. sub-class of this. I'm recommending you to see the sub-class javadoc... to help
 * you write elegant code.
 */
