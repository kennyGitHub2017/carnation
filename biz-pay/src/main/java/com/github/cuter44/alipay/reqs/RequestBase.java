...
public abstract class RequestBase {
	 ...
	 *                if <code>Key</code> or something else (related to algorithm) not found
	 */
	public abstract RequestBase sign() throws UnsupportedEncodingException, UnsupportedOperationException,
	 ...
	 * @param signType
	 *            MD5/DSA/RSA/0001, currently supported MD5 only.
	 * @param charset
	 *            utf-8/gb2312, utf-8 recommended.
	 */
	...
	/**
	 * Generate full URL for execute Auxiliary function to generate excat URL of the request, which can be
	 * executed correctly by a http-client.
	 */
	public abstract String toURL() throws UnsupportedEncodingException;

	// EXECUTE
	/**
	 * Execute the constructed query
	 */
	public abstract ResponseBase execute() throws AlipayException;
