...
public class Configure {
	...
	private static String certPassword = "1377634902";
	 ...
	 *            加密秘钥
	 */
	public static void initialize(String appID, String mchID, String subMchID, String certLocalPath,
			String certPassword, String key, String notifyCallbackUrl) {
