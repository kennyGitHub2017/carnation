...
/**
 * Copyright 2016 All right reserved. DES加密解密类.
 */
public class Des {
	/** 加密、解密key. */
	...
	public static void main(String[] args) throws Exception {
		...
		/*  String md5Password = "123456789_";
		  
		  String str = Des.encrypt(md5Password,PASSWORD_CRYPT_KEY_JG);
		  System.out.println("str: " + str);
		  */
		String str = "261768E857247094012533FF298349EA";

		str = Des.decrypt(str, PASSWORD_CRYPT_KEY_JG);
		System.out.println("str: " + str);
	}
