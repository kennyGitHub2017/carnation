...
/**
 * {@link AbstractAuthenticator} that redirects to a form. Note that other implementations can go wild because
 * they have access to the {@link HttpServletRequest} and {@link HttpServletResponse}.
 * 
 */
...
public class FormLoginAuthenticator extends AbstractAuthenticator {
	...
	/**
	 * 
	 * Hook for actually validating the username/ password against a database, ldap, external webservice or
	 * whatever to perform authentication
	 * 
	 * @param request
