...
import com.sinco.carnation.elong.model.elong.EnumCurrencyCode;
import com.sinco.carnation.elong.model.elong.EnumGuestTypeCode;
import com.sinco.carnation.elong.model.elong.EnumInvoiceMode;
...
public class RoomRatePlan {
	...
	/**
	 * 是否取消（0--不可取消1--限时取消，限时取消是存现取消规则但有时间限制，见LatestCancelTime字段2--免费取消）
	 */
	private boolean cancelRuleType;
	...
	public boolean isCancelRuleType() {
		return cancelRuleType;
	}

	public void setCancelRuleType(boolean cancelRuleType) {
		this.cancelRuleType = cancelRuleType;
	}
