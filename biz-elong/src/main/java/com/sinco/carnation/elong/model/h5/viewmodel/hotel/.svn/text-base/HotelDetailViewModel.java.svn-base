...
public class HotelDetailViewModel extends HotelDetailForListPager {
	 ...
	 * 最近预定时间间隔
	 */
	private Integer recentTimeInterval;
	/**
	 * 纬度
	 */
	...
	public Integer getRecentTimeInterval() {
		return recentTimeInterval;
	}

	public void setRecentTimeInterval(Integer recentTimeInterval) {
		this.recentTimeInterval = recentTimeInterval;
	}
	...
	public String getHotelFlags() {
		return hotelFlags;
	}

	public void setHotelFlags(String hotelFlags) {
